document.addEventListener('DOMContentLoaded', function () {
  ...
  document.addEventListener('mousemove', function (e) {
    ...
    updateTimer = setTimeout(function () {
      ...
      if (distance > 1) {
        updateTimer = setTimeout(arguments.callee, 30);
      }
...
// navbar position after animation
// document.addEventListener('DOMContentLoaded', function() {
//   var navbar = document.querySelector('.navbar');
//   var intro_main = document.querySelector('.intro-main');

//   navbar.addEventListener('animationend', function() {
//     navbar.classList.add('animation-done');
//   });

//   intro_main.addEventListener('animationend', function() {
//     intro_main.classList.add('animation-done');
//   });
// });
